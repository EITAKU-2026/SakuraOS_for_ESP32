...
* **Important Note: Please be aware that the system user interface (UI), display text, and all source code comments (notes written after //) are only available in Japanese. We sincerely apologize for any inconvenience this may cause.**
